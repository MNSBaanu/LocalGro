                ...
                <tr key={item.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">Updated: {formatDate(item.lastUpdated)}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-gray-900">LKR {item.price.toLocaleString()}</div>
                    <div className="text-sm text-gray-500">Total: LKR {(item.quantity * item.price).toLocaleString()}</div>
                  </td>
